...
const ENDPOINT = process.env.NEXT_PUBLIC_SOCKET_SRVER_URI || "";
...
const CourseContentMedia = ({
  ...
  const handleQuestion = () => {
    if (question.length === 0) {
      toast.error("Question cann't be empty");
    } else {
      console.log({
        question,
        courseId: id,
  ...
  return (
    <div className="w-[95%] 800px:w-[86%] py-4 m-auto">
      ...
      <div className="w-full flex items-center justify-between my-3">
        ...
        >
          <AiOutlineArrowLeft clasName="mr-2" />
          Prev Lesson
        </div>
        <div
          className={`${
        ...
        >
          Next Lesson
          <AiOutlineArrowRight clasName="mr-2" />
        </div>
      </div>
                      ...
                      <div className="w-full flex 800px:ml-16 my-5" key={index}>
                        ...
                        <div className="pl-2">
                          <div className="flex items-center">
                            ...
                            {i.user.role === "admin" && (
                              <VscVerifiedFilled className="text-[#7544dd] ml-2 text-[20px]" />
                            )}
                          </div>
                          <p>{i.comment}</p>
      ...
      <div className="my-4">
        <div className="flex mb-2">
          ...
          <div className="pl-3 dark:text-white text-black">
            ...
            <p>{item?.question}</p>
            <small className="text-[#0d0c0c83] dark:text-white ">
        ...
        <div className="w-full flex">
          <span
            className=" 800px:pl-16 text-[#0d0c0c83] dark:text-[#ffffff83] cursor-pointer mr-2"
            onClick={() => {
          ...
          <BiMessage
            size={20}
            className="cursor-pointer text-[#0d0c0c83] dark:text-[#ffffff83]"
          />
          <span className="pl-1 mt-[-4px] cursor-pointer text-[#0d0c0c83] dark:text-[#ffffff83] ">
