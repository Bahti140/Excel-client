...
const AllCourses: FC<Props> = ({ isTeam }) => {
 ...
 // const [deleteUser, {isSeccess: deleteSuccess, error: deleteError}] = useDeleteUserMutation({})
...
//     if(deleteSuccess) {
//         refetch()
//         toast.success("Delete user succefully!")
//         setOpen(false)
//     }
//     if(deleteError) {
...
//   }, [updateError, isSuccess, deleteSuccess, deleteError])
  ...
  const columns = [
    ...
    { field: "created_at", headerName: "Joind At", flex: 0.5 },
      ...
      {isLoading ? (
        ...
        <Box m="20px">
          <div className="w-full flex justify-end">
            <div
              className={`${styles.button}  !w-[200px] dark:bg-[#57c7a3] !h-[35px] dark:border rounded-[4.5px] dark:border-[#ffffff6c]`}
